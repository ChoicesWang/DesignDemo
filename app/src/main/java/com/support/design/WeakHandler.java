...
public class WeakHandler {
    ...
    private static class ExecHandler extends Handler {
        private final WeakReference<Handler.Callback> weakReferenceCallback;

        ExecHandler() {
            weakReferenceCallback = null;
        }

        ExecHandler(WeakReference<Handler.Callback> weakReferenceCallback) {
            this.weakReferenceCallback = weakReferenceCallback;
        }
        ...
        public void handleMessage(@NonNull Message msg) {
            if (weakReferenceCallback == null) {
                return;
            }
            final Handler.Callback callback = weakReferenceCallback.get();
